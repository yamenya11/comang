// Generated from C:/Users/Yamen/IdeaProjects/Finalangular/src/antlr/HTMLParser.g4 by ANTLR 4.13.2
package antlr;
...
public class HTMLParser extends Parser {
	...
	public static final int
		...
		IMPORT=7, COMPONENT=8, FROM=9, EXPORT=10, CLASS=11, FOR=12, WHILE=13, 
		SWITCH=14, CASE=15, DEFAULT=16, INTERFACE=17, LET=18, CONST=19, IN=20, 
		IF=21, ELSE=22, AT=23, PROVIDEDIN=24, SELECTOR=25, TEMPLATEURL=26, STYLEURLS=27, 
		ANY=28, NUMBER=29, CONSTRUCTOR=30, NGONINIT=31, THIS=32, ARRAY=33, PRIVATE=34, 
		PUBLIC=35, PROTECTED=36, EXPORTAS=37, INJECTABLE=38, INPUT=39, OUTPUT=40, 
		Input=41, NEW=42, IMPLEMENTS=43, EXTENDS=44, ONINIT=45, OPEN_CURLY=46, 
		CLOSE_CURLY=47, OPEN_SQUARE=48, CLOSE_SQUARE=49, OPEN_PAREN=50, CLOSE_PAREN=51, 
		COLON=52, COMMA=53, SEMICOLON=54, EQUALS=55, OR_OPERATOR=56, NOT_EQUAL=57, 
		STRICT_NOT_EQUAL=58, ARROW=59, STRING=60, IDENTIFIER=61, INTEGER=62, LINE_COMMENT=63, 
		BLOCK_COMMENT=64, WS=65, LESS_THAN=66, GREATER_THAN=67, STAR=68, DIVIDE=69, 
		MOD=70, PLUS=71, MINUS=72, DOT=73, CLOSE_TAG=74, SELF_CLOSING_HTML_TAG=75, 
		DOUBLE_CURLY_OPEN=76, DOUBLE_CURLY_CLOSE=77, TAG_NAME=78, TAG_SLASH_CLOSE=79, 
		TAG_EQUALS=80, ATTVALUE_VALUE=81, HTML_TEXT=82, SCRIPT_OPEN=83, SCRIPT_BODY=84, 
		SCRIPT_SHORT_BODY=85, STYLE_OPEN=86, STYLE_BODY=87, STYLE_SHORT_BODY=88;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, null, null, "'import'", null, "'from'", 
			"'export'", "'class'", "'for'", "'while'", "'switch'", "'case'", "'default'", 
			"'interface'", "'let'", null, "'in'", "'if'", "'else'", "'@'", "'providedIn'", 
			"'selector'", "'templateUrl'", "'styleUrls'", "'any'", "'number'", "'constructor'", 
			"'ngOnInit'", "'this'", "'array'", "'private'", "'public'", "'protected'", 
			"'exportas'", "'@Injectable'", "'@Input'", "'@Output'", "'input'", "'new'", 
			"'implements'", "'extends'", "'  OnInit'", "'{'", "'}'", "'['", "']'", 
			"'('", "')'", "':'", "','", "';'", "'='", "'|'", "'!='", "'!=='", "'=>'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SCRIPTLET", "IMPORT", "COMPONENT", "FROM", "EXPORT", "CLASS", "FOR", 
			"WHILE", "SWITCH", "CASE", "DEFAULT", "INTERFACE", "LET", "CONST", "IN", 
			"IF", "ELSE", "AT", "PROVIDEDIN", "SELECTOR", "TEMPLATEURL", "STYLEURLS", 
			"ANY", "NUMBER", "CONSTRUCTOR", "NGONINIT", "THIS", "ARRAY", "PRIVATE", 
			"PUBLIC", "PROTECTED", "EXPORTAS", "INJECTABLE", "INPUT", "OUTPUT", "Input", 
			"NEW", "IMPLEMENTS", "EXTENDS", "ONINIT", "OPEN_CURLY", "CLOSE_CURLY", 
			"OPEN_SQUARE", "CLOSE_SQUARE", "OPEN_PAREN", "CLOSE_PAREN", "COLON", 
			"COMMA", "SEMICOLON", "EQUALS", "OR_OPERATOR", "NOT_EQUAL", "STRICT_NOT_EQUAL", 
			"ARROW", "STRING", "IDENTIFIER", "INTEGER", "LINE_COMMENT", "BLOCK_COMMENT", 
			"WS", "LESS_THAN", "GREATER_THAN", "STAR", "DIVIDE", "MOD", "PLUS", "MINUS", 
			"DOT", "CLOSE_TAG", "SELF_CLOSING_HTML_TAG", "DOUBLE_CURLY_OPEN", "DOUBLE_CURLY_CLOSE", 
			"TAG_NAME", "TAG_SLASH_CLOSE", "TAG_EQUALS", "ATTVALUE_VALUE", "HTML_TEXT", 
	...
	public final HtmlDocumentContext htmlDocument() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 70L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 2359299L) != 0)) {
				{
				{
				setState(46);
				htmlElements();
	...
	public final HtmlElementsContext htmlElements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==HTML_COMMENT || _la==HTML_CONDITIONAL_COMMENT || _la==WS) {
				{
				{
				setState(54);
				htmlMisc();
	...
	public static class HtmlElementContext extends ParserRuleContext {
		public List<TerminalNode> LESS_THAN() { return getTokens(HTMLParser.LESS_THAN); }
		public TerminalNode LESS_THAN(int i) {
			return getToken(HTMLParser.LESS_THAN, i);
		}
		public List<TerminalNode> TAG_NAME() { return getTokens(HTMLParser.TAG_NAME); }
		public TerminalNode TAG_NAME(int i) {
			return getToken(HTMLParser.TAG_NAME, i);
		}
		public List<TerminalNode> GREATER_THAN() { return getTokens(HTMLParser.GREATER_THAN); }
		public TerminalNode GREATER_THAN(int i) {
			return getToken(HTMLParser.GREATER_THAN, i);
		}
